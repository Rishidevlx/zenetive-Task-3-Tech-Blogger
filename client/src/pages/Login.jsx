    ...
    <div style={{ minHeight: '80vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      >
        <div style={{ textAlign: 'center', marginBottom: '35px' }}>
          <h2 style={{ fontSize: '2.4rem', color: 'var(--text-main)', marginBottom: '10px' }}>Welcome Back</h2>
          <p style={{ color: 'var(--text-muted)' }}>Sign in to continue to Tech Blogs.</p>
        </div>
        ...
        <form onSubmit={onSubmit}>
          ...
          <div className="form-group">
            ...
            <input type="password" name="password" value={password} onChange={onChange} required placeholder="••••••••" style={{ letterSpacing: '2px' }} />
          </div>
        ...
        <p style={{ textAlign: 'center', marginTop: '35px', color: 'var(--text-muted)' }}>
          Don't have an account? <Link to="/register" style={{ fontWeight: '600', color: 'var(--secondary)' }}>Sign up</Link>
        </p>
      </motion.div>
    </div>
  );
